...
const Notification = () => {
    ...
    const { notifications, userChats, allUsers, markAllNotificationAsRead, markNotificationsAsRead } = useContext(ChatContext);
    ...
    console.log("modified", modifiedNotification)
